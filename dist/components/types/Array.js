...
var ArrayType = exports["default"] = /*#__PURE__*/function (_Component) {
  function ArrayType() {
    var _this;
    ...
    _this = _callSuper(this, ArrayType, [].concat(args));
...
_defineProperty(ArrayType, "defaultProps", {
  knob: {},
  onChange: function onChange(value) {
    return value;
  }
});
_defineProperty(ArrayType, "propTypes", {
...
_defineProperty(ArrayType, "serialize", function (value) {
  return value;
});
_defineProperty(ArrayType, "deserialize", function (value) {
